...
// 	/** only revoke a user who's been shared with **/
// 	target_rsapub, ok := userlib.KeystoreGet(target_username)
// 	if !ok { return "", errors.New("Recipient " + target_username + " not found or doesn't exist.") }



// 	/** get the file data from Datastore, including all the appends. Combine into 1 file **/
// 	data, err := userdata.LoadFile(filename)
// 	if err != nil { return errors.New("Owner can't load the file data") }


// 	/** Delete the old file in Datastore **/
